                            ...
                            <View style={{ flexDirection: "column", flex: 1, marginTop: 15 }}>
                                ...
                                <View style={[MainStyles.textBD, { marginVertical: 20 }]}>
                                    ...
                                    <View style={{ flex: 1, marginTop: 50 }}>
                                        ...
                                        <Text allowFontScaling={false} style={[MainStyles.Text12, MainStyles.textAlignLeft, MainStyles.textGrayLight]}>ด้วยตระหนักถึงปัญหาของคนเมืองในด้านอาหาร ทั้งเรื่องความปลอดภัย และความมั่นคงทางอาหาร รวมถึงปัญหาด้านสุขภาพ สังคมและสิ่งแวดล้อมของเมือง เราจึงมุ่งยกระดับการพึ่งตนเองด้านอาหารของคนเมือง และผนวกเรื่องการปลูกผักแบบไม่ใช้สารเคมีและการพึ่งตนเองด้านอื่นๆให้อยู่ในวิถีชีวิตของคนเมือง พร้อมทั้งมุ่งยกระดับความคิด สร้างความตระหนักถึงบทบาทของเกษตรในเมืองในฐานะที่มีส่วนช่วยพัฒนาระบบอาหารและวิถีชีวิตทางเลือกที่เกื้อกูลธรรมชาติ สร้างสังคมการอยู่ร่วมกันทั้งในเมือง ระหว่างคนเมืองกับชนบทและทรัพยากรธรรมชาติ … อ่านต่อ</Text>
                                    </View>
