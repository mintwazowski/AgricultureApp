...
export default class SellerRegisterInfo extends Component {
                        ...
                        <View style={[MainStyles.m15]}>
                            ...
                            <View style={{ flexDirection: 'column', margin: 15 }}>
                                ...
                                <View style={styles.contentTitleRow}>
                                    <Text allowFontScaling={false} style={[MainStyles.textWhite, MainStyles.Text16]}>ข้อมูลที่อยู่และการติดต่อ</Text>
                                    <View style={{ flex: 1, alignItems: 'flex-end' }}>
                                        <MaterialIcons name='keyboard-arrow-down' size={20} color="#fff" style={{ marginTop: 3 }} />
                                    </View>
                                </View>
                                <View style={styles.contentTitleRowGray}>
                                    <Text allowFontScaling={false} style={[MainStyles.textGray, MainStyles.Text16]}>ข้อมูลแผนที่และพิกัดที่ตั้ง</Text>
                                    <View style={{ flex: 1, alignItems: 'flex-end' }}>
                                        <MaterialIcons name='keyboard-arrow-down' size={20} color="#fff" style={{ marginTop: 3 }} />
                                    </View>
                                </View>
                                ...
                                <View style={styles.contentTitleRowGray}>
                                    <Text allowFontScaling={false} style={[MainStyles.textGray, MainStyles.Text16]}> ข้อมูลวันที่และเวลาทำการ</Text>
                                    <View style={{ flex: 1, alignItems: 'flex-end' }}>
                                        <MaterialIcons name='keyboard-arrow-down' size={20} color="#fff" style={{ marginTop: 3 }} />
                                    </View>
                                </View>
                                <View style={styles.contentTitleRow}>
                                    <Text allowFontScaling={false} style={[MainStyles.textWhite, MainStyles.Text16]}>ข้อมูลอัตราค่าเข้าชม</Text>
                                    <View style={{ flex: 1, alignItems: 'flex-end' }}>
                                        <MaterialIcons name='keyboard-arrow-down' size={20} color="#fff" style={{ marginTop: 3 }} />
                                    </View>
                                </View>
                                <View style={styles.contentTitleRowGray}>
                                    <Text allowFontScaling={false} style={[MainStyles.textGray, MainStyles.Text16]}>ข้อมูลกลุ่มเป้าหมาย</Text>
                                    <View style={{ flex: 1, alignItems: 'flex-end' }}>
                                        <MaterialIcons name='keyboard-arrow-down' size={20} color="#fff" style={{ marginTop: 3 }} />
                                    </View>
                                </View>
                                <View style={styles.contentTitleRow}>
                                    <Text allowFontScaling={false} style={[MainStyles.textWhite, MainStyles.Text16]}>ข้อมูล Social Network</Text>
                                    <View style={{ flex: 1, alignItems: 'flex-end' }}>
                                        <MaterialIcons name='keyboard-arrow-down' size={20} color="#fff" style={{ marginTop: 3 }} />
                                    </View>
                                </View>
