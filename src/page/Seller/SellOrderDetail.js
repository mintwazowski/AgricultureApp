...
export default class SellOrderDetail extends Component {
                    ...
                    <View style={[MainStyles.contentBG]}>
                        ...
                        <View style={[MainStyles.m15]}>
                            ...
                            <View style={{ flexDirection: 'column' }}>
                                ...
                                <View style={{ flexDirection: 'column', marginTop: 5 }}>
                                    ...
                                    <View style={{ flexDirection: 'row', marginTop: 20 }}>
                                        ...
                                        <View style={{ flexDirection: 'column' }}>
                                            ...
                                            <Text allowFontScaling={false} style={[MainStyles.textGray, MainStyles.Text14, MainStyles.mb10]}>
                                                • 28  มกราคม 2565
                                            </Text>
                                            <Text allowFontScaling={false} style={[MainStyles.textGray, MainStyles.Text16]}>
                                                เวลา
                                ...
                                <View style={[{ flexDirection: 'row', alignSelf: 'center', paddingBottom: 50, marginTop: 20 }]}>
                                    <TouchableOpacity
                                        activeOpacity={1}
                                    ...
                                    >
                                        ...
                                        <Text allowFontScaling={false} style={[MainStyles.btnLoadMoreText, { marginLeft: 10 }]}>ยืนยันการรับเงิน
