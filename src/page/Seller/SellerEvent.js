...
export default class SellerEvent extends Component {
                            ...
                            <View style={{ flexDirection: 'column' }}>
                                <View style={{ flexDirection: 'row', width: '100%', marginBottom: 20 }}>
                                    <View style={[{ width: '49%' }]}>
                                        ...
                                        >
                                            <Text allowFontScaling={false} style={[MainStyles.btnSmallBor]}>รายการจองรอยืนยัน</Text>
                                            <View style={{
                                                width: 17,
                                                height: 17,
                                                borderRadius: 50,
                                    ...
                                    <View style={[{ width: '49%' }]}>
                                        ...
                                        >
                                            <Text allowFontScaling={false} style={[MainStyles.btnSmallBor]}>รายการจองกิจกรรมสำเร็จ</Text>
                                            <View style={{
                                                width: 17,
                                                height: 17,
                                                borderRadius: 50,
                                ...
                                <View style={styles.contentCartShopProductGray}>
                                    <View style={styles.contentCartShopProductList}>
                                        ...
                                        <View style={{ flexDirection: 'column', marginLeft: 10, }}>
                                            ...
                                            <View style={{ flexDirection: 'row', marginTop: 5 }}>
                                                <FontAwesome5 name='clock' style={styles.TransactionMenucustomIcon} size={15} color="#333" />
                                                <Text allowFontScaling={false} style={[MainStyles.textGray, MainStyles.Text12, MainStyles.ml10]}>
                                                    08.00 น. - 10.00 น
                                                </Text>
                                            </View>
                                            <View style={{ flexDirection: 'row', marginTop: 5 }}>
                                                <FontAwesome5 name='people-arrows' style={styles.TransactionMenucustomIcon} size={15} color="#333" />
                                                <Text allowFontScaling={false} style={[MainStyles.textGray, MainStyles.Text12, MainStyles.ml10]}>
                                                    จำนวน 10  คน
                                                </Text>
                                            </View>
                                            <View style={{ flexDirection: 'row', marginTop: 5 }}>
                                                <MaterialIcons name='food-bank' style={styles.TransactionMenucustomIcon} size={20} color="#333" />
                                                <Text allowFontScaling={false} style={[MainStyles.textGray, MainStyles.Text12, MainStyles.ml10]}>
                                                    อาหารเช้า 10  คน
                                                </Text>
                                            </View>
                                    ...
                                    <View style={[{ flexDirection: 'row' }]}>
                                        <TouchableOpacity
                                            activeOpacity={1}
                                            style={[MainStyles.btnCartGreen4, { marginRight: 10, flexDirection: 'row', justifyContent: 'center' }]}
                                        >
                                            <FontAwesome5 name='check-circle' style={styles.customIcon} size={15} solid color="#FFF" />
                                            <Text allowFontScaling={false} style={[MainStyles.btnLoadMoreText, { marginLeft: 10 }]}>ยืนยันการจองเข้าร่วมกิจกรรม</Text>
                                        </TouchableOpacity>
